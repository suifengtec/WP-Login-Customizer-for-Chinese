...
class Logo extends Front
{
    ...
    function __construct($selector = '')
    {
        ...
        if ( ! get_option('cwp_login_logo_hide')){
            if (get_option('cwp_login_logo_link'))
                add_filter('login_headerurl', array($this, 'link'));
            if (get_option('cwp_login_logo_title'))
    ...
    function link()
    {
        return get_option( 'cwp_login_logo_link' );
    }

    function title()
    {
        return get_option( 'cwp_login_logo_title' );
    }
