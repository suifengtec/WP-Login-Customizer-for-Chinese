...
class Front extends CWP_P_FW {

    public static $styles = array();
    public static $scripts = array();
    public static $css = '';
    public static $js = '';
    public static $body_classes = array('clt-login');

    function __construct(){}

    static function init(){
        add_filter( 'login_body_class' , array( 'cwp_login\front\Front' , 'body_class' ) );
        add_action( 'login_enqueue_scripts' , array( 'cwp_login\front\Front' , 'add_css' ) , 12);
        add_action( 'login_enqueue_scripts' , array( 'cwp_login\front\Front' , 'load_scripts' ) );
        ...
        self::$scripts[] = array('main-front-js',self::$plugin_uri . '/js/login-screen.js?v='.time(),array('jquery'),true);
    }
