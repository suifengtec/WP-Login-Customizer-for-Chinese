...
class Page extends CWP_P_FW{
    ...
    public function actions(){
        wp_localize_script('clt-admin-deps', 'cl_deps' , $this->dependencies );
    }
     ...
     * @return Tab
     */
    public function add_tab($name, $description = '', $icon = '',$slug=''){
        if ( $this->main_tab )
            return new Tab($name, $description, $icon, $this,false, $slug);
        else
            return $this->main_tab = new Tab( $name, $description, $icon, $this, true, $slug );
    }
